...
**       microcode fixes. Implemented the line primitive routine.
...
void __stdcall geLine( RC *pRc, LPDWORD pF, LPDWORD pA, LPDWORD pB, DWORD vertexType )
{
    SETUP_PPDEV(pRc)
    DWORD i;
    ...
    CMDFIFO_CHECKROOM( cmdFifo, PH6_SIZE+(FVFO_SIZE*2) );

    //Send the packet header
    SETPH(cmdFifo,
          CMDFIFO_BUILD_PK6_a(0, 1, 0,
                              1, 1, 0,
                              kPkt6aCmdDrawAB,
                              0));
