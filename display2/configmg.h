...
{ \
        ...
        "_CONFIGMG_Get_Log_Conf_Priority", \
...
#define CM_CAPABILITIES_BITS                    0x00000001
...
#define CM_ADD_REMOVE_DEVNODE_PROPERTY_BITS             0x00000007
...
#define NUM_ARB_COMMANDS        0x0000000B      // Number of arb commands.
...
MAKE_CM_HEADER(Get_Log_Conf_Priority, (PPRIORITY pPriority, LOG_CONF lcLogConf, ULONG ulFlags))
